...
class LectureActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val type: LectureNavigationType =
            intent.getSerializableExtra(KEY_TYPE) as LectureNavigationType
    ...
    companion object {
        fun getIntent(context: Context, lectureInfoId: Long, type: LectureNavigationType): Intent =
