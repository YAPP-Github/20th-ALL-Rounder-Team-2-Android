...
internal interface ApiService {
    ...
    @GET("user/lecture/me")
    suspend fun getPlayerLectures(@Query("state") state: LectureResponseLegacy.State? = null): PlayerLectureResponseWrapper

    @GET("coach/lecture/me")
    suspend fun getCoachLectures(@Query("state") state: LectureResponseLegacy.State? = null): CoachLectureResponseWrapper
